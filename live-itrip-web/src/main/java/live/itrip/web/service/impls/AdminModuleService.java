...
import live.itrip.web.dao.AdminModuleMapper;
...
import live.itrip.web.service.intefaces.IAdminOperationService;
...
public class AdminModuleService extends BaseService implements IAdminModuleService {
     ...
     */
    @Override
    public List<AdminModule> selectModulesByUser(AdminUser user) {
